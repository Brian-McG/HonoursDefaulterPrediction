...
\begin{document}
	...
	\begin{figure*}
		...
		\vspace{-1em}
		\makebox[\linewidth]{
			\includegraphics[scale=0.6]{Parameter_tuning_approach_results_per_classifier_plot_['Lima_TB',_'India_Attrition',_'German_Credit',_'Australia_Credit']_Balanced_Accuracy_2016-11-10_19-13-31}}
	...
	\begin{table*}
		...
		\begin{tabular}{l|c|c|c|c|c|c|c} \hline		
			Classifier&BACC&MCC&BS&H-measure&TPR&TNR&\parbox[t]{1.1cm}{\centering Time to fit\textsuperscript{\textdagger} (s)}\\ \hline 
			RF			&\textbf{0.8276 (0.0121)}	&0.6017	(0.0236)			&0.1526	(0.0087)			&\textbf{0.5312	(0.0275)}	&0.8789	(0.0167)			&0.7587	(0.0201)			&\textbf{0.0202	(0.0006)}\\ 
			Bernoulli NB&0.8188 (0.0138)			&\textbf{0.6123	(0.0280)}	&0.1363	(0.0101)			&0.5261	(0.0285)			&0.8208	(0.0278)			&0.8156	(0.0261)			&4.4187	(1.2427)\\  
			ANN			&0.8182 (0.0135)			&0.6113	(0.0264)			&\textbf{0.1301 (0.0069)}	&0.5205	(0.0267)			&0.7758	(0.0232)			&0.8478	(0.0148)			&1.9288	(0.1000)\\ 

...
%	\end{table}
	...
	\begin{figure*}
		\centering
		\makebox[\linewidth]{
		\includegraphics[scale=0.6]{Parameter_tuning_approach_results_per_classifier_plot_['Lima_TB',_'German_credit',_'Australian_credit']_Balanced_Accuracy_2016-10-24_18-55-57}}

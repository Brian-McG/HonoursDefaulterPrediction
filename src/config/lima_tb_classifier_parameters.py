"""Contains all classifier parameters for Lima TB dataset"""
...
elm_parameters = {"layers": [(20, 'rbf_l2')]}
...
svm_parameters = {"cache_size": 1000, "gamma": "auto", "C": 7.896842105, "kernel": "rbf", "class_weight": "balanced", "decision_function_shape": "ovr", "probability": True, "max_iter": 1000000}
...
svm_linear_parameters = {"C": 7.371053, "decision_function_shape": "ovr", "cache_size": 1000, "kernel": "linear", "class_weight": None, "max_iter": 1000000}
...
svm_poly_parameters = {"cache_size": 1000, "decision_function_shape": "ovr", "C": 1.11888888888888, "gamma": 0.1112, "kernel": "poly", "degree": 3, "class_weight": None, "max_iter": 1000000}

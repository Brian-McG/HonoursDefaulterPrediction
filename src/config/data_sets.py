...
def append_data_set_details(data_set_path, numeric_columns, categorical_columns, binary_columns, classification_label, time_to_default, missing_values_strategy, feature_selection_strategy, status,
    ...
    data_sets.append(
        {"data_set_path": data_set_path, "numeric_columns": numeric_columns, "categorical_columns": categorical_columns, "binary_columns": binary_columns, "classification_label": classification_label,
...
append_data_set_details(chw_attrition_path, chw_attrition_numeric_columns, chw_attrition_categorical_columns, chw_attrition_binary_columns, chw_attrition_classification_label,
                        ...
                        chw_attrition_missing_values_strategy, chw_attrition_feature_selection_strategy, chw_attrition_enabled, india_attrition_classifier_parameters, "India_CHW_attrition",
                        india_attrition_data_balancer_only_parameters, "userCode", data_set_arr)
...
append_data_set_details(german_credit_path, german_credit_numeric_columns, german_credit_categorical_columns, german_credit_binary_columns, german_credit_classification_label,
                        german_credit_time_to_default,
                        german_credit_missing_values_strategy, german_credit_feature_selection_strategy, german_credit_enabled, german_credit_parameters, "German_credit",
...
append_data_set_details(australian_credit_path, australian_credit_numeric_columns, australian_credit_categorical_columns, australian_credit_binary_columns, australian_credit_classification_label,
                        ...
                        australian_credit_missing_values_strategy, australian_credit_feature_selection_strategy, australian_credit_enabled, australian_credit_parameters, "Australian_credit",

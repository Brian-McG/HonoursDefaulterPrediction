...
def append_data_set_details(data_set_path, numeric_columns, categorical_columns, binary_columns, classification_label, time_to_default, missing_values_strategy, feature_selection_strategy, status, classifier_parameters,
...
lima_tb_binary_columns = [("Prison Hx", "Yes", "No"), ("Completed Secondary Education", "Yes", "No"), ("Alcohol Use at Least Once Per Week", "Yes", "No"), ("History of Drug Use", "Yes", "No"), ("Hx of Rehab", "Yes", "No"), ("MDR-TB", "Yes", "No"), ("Hx Chronic Disease", "Yes", "No"), ("Hx Diabetes Melitus", "Yes", "No")]

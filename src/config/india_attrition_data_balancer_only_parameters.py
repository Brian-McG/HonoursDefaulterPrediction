"""Contains all classifier parameters for Indian attrition dataset only using balancers and default parameters for rest"""
...
clustering_launched_classifier_data_balancer = OneSidedSelection

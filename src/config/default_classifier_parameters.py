...
svm_parameters = {"cache_size": 1000, "gamma": "auto", "kernel": "rbf", "class_weight": "balanced", "probability": True}
...
voting_classifier_parameters = {
    ...
    "voting": "hard"}
append_classifier_details(voting_classifier_data_balancer, voting_classifier_parameters, clfrs.voting_classifier_description, classifier_parameters)

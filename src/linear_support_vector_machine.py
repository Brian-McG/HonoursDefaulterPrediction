...
class LinearSupportVectorMachineClassification(MLTechnique):
    ...
    def train_and_evaluate(self, defaulter_set):
        ...
        for i in range(const.NUMBER_OF_FOLDS):
            data_balancer = None
            rfc = svm.SVC(cache_size=1000, gamma='auto', kernel='linear', class_weight='balanced')
...
if __name__ == "__main__":
    ...
    svm_imp = LinearSupportVectorMachineClassification()

...
def append_classifier_details(data_balancer, classifier, status, classifier_description, classifier_arr):
    ...
    classifier_arr.append({'classifier': classifier, 'data_balancer': data_balancer, 'status': status, 'classifier_description': classifier_description})
...
append_classifier_details(decision_tree_data_balancer, decision_tree, decision_tree_enabled, "Decision Tree", generic_classifiers)
...
append_classifier_details(random_forest_data_balancer, random_forest, random_forest_enabled, "Random forest", generic_classifiers)

# K-nearest neighbours
k_nearest_data_balancer = SMOTEENN()
k_nearest = KNeighborsClassifier(n_neighbors=100)
k_nearest_enabled = False
append_classifier_details(k_nearest_data_balancer, k_nearest, k_nearest_enabled, "K-nearest neighbours", generic_classifiers)

# Multinomial Naive Bayes
multinomial_naive_bayes_data_balancer = SMOTEENN()
multinomial_naive_bayes = MultinomialNB()
multinomial_naive_bayes_enabled = False
append_classifier_details(multinomial_naive_bayes_data_balancer, k_nearest, k_nearest_enabled, "Multinomial Naive Bayes", generic_classifiers)
...
voting_classifier = VotingClassifier(estimators=[('classifier_one', classifier_one), ('classifier_two', classifier_two), ('classifier_three', classifier_three), ('classifier_four', classifier_four)], voting='hard')
voting_classifier_enabled = False
append_classifier_details(voting_classifier_data_balancer, voting_classifier, voting_classifier_enabled, "Voting classifier", generic_classifiers)
